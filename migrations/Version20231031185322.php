 ...
 */
final class Version20231031185322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, employee_id INT DEFAULT NULL, status VARCHAR(255) NOT NULL, payment DATETIME NOT NULL, deposit DATETIME NOT NULL, pick_up DATETIME NOT NULL, content JSON NOT NULL, total_price INT NOT NULL, message LONGTEXT DEFAULT NULL, INDEX IDX_F529939819EB6921 (client_id), INDEX IDX_F52993988C03F15C (employee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
